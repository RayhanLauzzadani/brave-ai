...
class Settings(BaseSettings):
    ...
    gemini_video_fps: float = 5.0
    gemini_inline_max_bytes: int = 18 * 1024 * 1024
    gemini_request_timeout_seconds: float = 45.0
    gemini_max_retries: int = 1
    ai_detection_enabled: bool = False
    ai_detection_clip_seconds: int = 6
    ai_detection_interval_seconds: float = 6.0
    ai_detection_confidence_threshold: float = 0.8
    ai_detection_cooldown_seconds: int = 30
    ai_detection_camera_refresh_seconds: int = 15
    ai_detection_queue_size: int = 3
    ai_detection_max_concurrency: int = 3
    ai_detection_max_clip_age_seconds: float = 45.0
    ai_detection_frame_width: int = 480
